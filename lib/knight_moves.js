...
var KnightInTransitMovementHistory = /** @class */ (function () {
   ...
   */
    KnightInTransitMovementHistory.prototype.determineBestHistoryThatWorks = function (numRecursions, maxNumRecursions) {
        if (numRecursions > 20) {
            warn("determineBestHistoryThatWorks(): Entering with this.getSize() = ".concat(this.getSize(), ",  this = ").concat(this.toString(), ",  numRecursions = ").concat(numRecursions));
        }
        debug("determineBestHistoryThatWorks(): Entering with this.getSize() = ".concat(this.getSize(), ",  numRecursions = ").concat(numRecursions));
        ...
        for (var ii = 0; ii < iterateAllDirections.length; ii++) {
            ...
            */
            ...
            var bestKnightInTransitMovementHistoryFromThisSubtree = anotherPotentialHistoryToConsider.determineBestHistoryThatWorks(numRecursions + 1, undefined);
...
var KnightMoveRunner = /** @class */ (function () {
    ...
    KnightMoveRunner.prototype.run = function (chessBoard, knightStartingSquare, knightDestinationSquare) {
        ...
        var knightInTransitMovementHistory = initialHistory.determineBestHistoryThatWorks(0, undefined);
        return knightInTransitMovementHistory;
    };
